...
//       handleEdit(editingImageTrendingPlaceId, newImagesTrendPlace);
//     } else {
//       axiosInstance
//         .post('/countries/api/trendingPlaces/images/add/', newImagesTrendPlace)
//         .then((response) => {
...
//     axiosInstance
//       .put(`/countries/api/trendingPlaces/images/add/${imageId}/`, updatedImage)
//       .then((response) => {
//         console.log(response.data);
//         fetchData();
//       })
...
//     axiosInstance
//       .delete(`/countries/api/trendingPlaces/images/add/${imageId}/`)
//       .then((response) => {
//         console.log(response.data);
//         fetchData();
//       })
...
//             type="file"
//             name="photo"
//             value={newImagesTrendPlace.photo}
//             onChange={handleInputChange}
//           />
//         </label>
//         <br />
...
//       reader.onloadend = () => {
//         // You can update the UI with the preview if needed
