...
urlpatterns = [
    ...
    path('trending-places/', TrendingPlaceListCreateView.as_view(), name='trending-place-list-create'),
    path('trending-places/<int:pk>/', TrendingPlaceRetrieveUpdateDestroyView.as_view(), name='trending-place-retrieve-update-destroy'),
